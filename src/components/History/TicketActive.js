      ...
      <div className="bg-white rounded-md p-10 mt-7">
        <div className="flex">
          <div className="flex-col flex-1">
            <h3 className="text-sm	leading-6 text-[#AAAAAA] mb-3">Tuesday, 07 July 2020 - 04:30pm</h3>
            <h1 className="text-2xl text-xl	font-semibold	leading-9	">Spider-Man: Homecoming</h1>
          </div>
        ...
        <div className="flex justify-between">
          <div className="bg-[#00BA88] text-white rounded-md text-center p-2 w-1/4">
            Ticket In Active
          </div>
          <Link
